...
- [`a69312e`](https://github.com/mmstudio-games/armillae/commit/a69312e5e3dacbda3c194037141e466921c01b4d): Upgrade all Rig Provider profiles to exactly 0.42.0 and reject EOF without a genuine Provider terminal event.
